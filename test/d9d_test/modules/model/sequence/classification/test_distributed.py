...
from d9d_test.modules.model.sequence.classification.catalogue import D9D_MODEL_FACTORIES_CLS, D9D_PARALLELIZE_FN
...
def test_consistent_to_itself_dist(
    ...
    if schedule_info.has_last_stage:
        ...
        torch.testing.assert_close(loss_dist, loss_global, atol=2e-4, rtol=0.001)
