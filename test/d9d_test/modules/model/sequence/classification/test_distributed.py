...
from d9d_test.modules.model.sequence.classification.batch import build_classification_batch, shard_classification_batch
from d9d_test.modules.model.sequence.classification.catalogue import D9D_MODEL_FACTORIES_CLS, HEAD_NAME_CLS
...
def test_consistent_to_itself_dist(
    ...
    batch_global = build_classification_batch()
    batch_dist = shard_classification_batch(batch_global, dist_ctx)
    ...
    outputs_global = model_global(
        ...
        SequenceHeadsShared(
            ...
            heads={HEAD_NAME_CLS: SequencePoolingHeadShared(pooling_mask=batch_global.pooling_mask)},
        ),
    )
    loss_global = F.cross_entropy(outputs_global[HEAD_NAME_CLS].scores, batch_global.labels)
    ...
    shared_microbatches = tuple(
        SequenceHeadsShared(
            ...
            heads={
                HEAD_NAME_CLS: SequencePoolingHeadShared(
