...
@pytest.mark.parametrize(
    ...
    [
        ...
        MetricCase(
            ...
            steps=[
                MetricStep(
                    [MetricParams(torch.tensor([]))],
                    expect=torch.tensor(0.0)
                ),
                MetricStep(
                    [MetricParams(torch.tensor([10.5]))],
        ...
        MetricCase(
            ...
            steps=[
                MetricStep(
                    ...
                    params_per_rank=[MetricParams(torch.tensor(10.0)) for _ in range(8)]
                ),
                MetricStep(
        ...
        MetricCase(
            ...
            steps=[
                MetricStep(
                    ...
                    params_per_rank=[MetricParams(torch.tensor(float(i))) for i in range(8)]
                )
            ]
        )
    ]
