...
def test_distribute_layers_scenarios(
    ...
    for i in range(num_stages):
        ...
        start, end = distribute_layers_for_pipeline_stage(num_layers, pre, post, stage_info)
    ...
    for stage in range(num_stages):
        with pytest.raises(ValueError):
            ...
            distribute_layers_for_pipeline_stage(
                num_layers=num_layers, num_virtual_layers_pre=pre, num_virtual_layers_post=post, stage=stage_info
            )
