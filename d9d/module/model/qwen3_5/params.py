...
class Qwen3p5VisionParameters(BaseModel):
    """Configuration parameters for the Qwen3.5 vision encoder.
...
class Qwen3p5LayerParameters(BaseModel):
    """Configuration parameters for a single Qwen3.5 dense decoder layer.
...
class Qwen3p5Parameters(BaseModel):
    """Configuration parameters for the Qwen3.5 dense model backbone.
