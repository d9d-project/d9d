...
from .params import Qwen3p5MoEVisionParameters


class Qwen3p5MoEVisionLayer(nn.Module, ModuleLateInit):
    """Implements a Qwen3.5 MoE vision transformer layer over packed media segments.
    ...
    def __init__(self, params: Qwen3p5MoEVisionParameters, sdpa_backend: AnySdpaBackendConfig | None = None):
        """Constructs a Qwen3p5MoEVisionLayer object.
...
class Qwen3p5MoEVisionModel(nn.Module, ModuleLateInit):
    ...
    def __init__(self, params: Qwen3p5MoEVisionParameters, sdpa_backend: AnySdpaBackendConfig | None = None):
        """Constructs the Qwen3p5MoEVisionModel object.
        ...
        self.blocks = nn.ModuleList(
            [Qwen3p5MoEVisionLayer(params, sdpa_backend=sdpa_backend) for _ in range(params.depth)]
        )
    ...
    def reset_parameters(self):
        ...
        for block in self.blocks:
            cast(Qwen3p5MoEVisionLayer, block).reset_parameters()
