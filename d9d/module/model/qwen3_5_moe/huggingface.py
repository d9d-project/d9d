...
def _mapper_from_huggingface_full_attention_layer(params: Qwen3p5MoELayerParameters) -> list[ModelStateMapper]:
    return [
...
def _mapper_to_huggingface_full_attention_layer(params: Qwen3p5MoELayerParameters) -> list[ModelStateMapper]:
    return [
...
def _mapper_from_huggingface_moe() -> list[ModelStateMapper]:
    return [
        ModelStateMapperSequential(
            [
        ...
        ModelStateMapperRename("mlp.shared_expert.gate_proj.weight", "mlp.shared_expert.expert.gate_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert.up_proj.weight", "mlp.shared_expert.expert.up_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert.down_proj.weight", "mlp.shared_expert.expert.down_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert_gate.weight", "mlp.shared_expert.gate.weight"),
    ]


def _mapper_to_huggingface_moe() -> list[ModelStateMapper]:
    return [
        ModelStateMapperSequential(
            [
                ModelStateMapperConcatenateTensors(
        ...
        ModelStateMapperRename("mlp.shared_expert.expert.gate_proj.weight", "mlp.shared_expert.gate_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert.expert.up_proj.weight", "mlp.shared_expert.up_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert.expert.down_proj.weight", "mlp.shared_expert.down_proj.weight"),
        ModelStateMapperRename("mlp.shared_expert.gate.weight", "mlp.shared_expert_gate.weight"),
    ]


def _mapper_from_huggingface_layer(params: Qwen3p5MoEParameters, layer_idx: int) -> ModelStateMapper:
...
def _mapper_to_huggingface_layer(params: Qwen3p5MoEParameters, layer_idx: int) -> ModelStateMapper:
    if params.is_full_attention_layer(layer_idx):
...
def mapper_from_huggingface_qwen3p5_moe_vision(params: Qwen3p5MoEVisionParameters) -> ModelStateMapper:
...
def mapper_to_huggingface_qwen3p5_moe_vision(params: Qwen3p5MoEVisionParameters) -> ModelStateMapper:
...
def _vocab_name_for(params: Qwen3p5MoEParameters) -> str:
...
def mapper_from_huggingface_qwen3p5_moe(params: Qwen3p5MoEParameters) -> ModelStateMapper:
    """Creates a state mapper translating base Qwen3.5 MoE HuggingFace keys into the d9d format.
...
def mapper_to_huggingface_qwen3p5_moe(params: Qwen3p5MoEParameters) -> ModelStateMapper:
    """Creates a state mapper translating d9d base Qwen3.5 MoE keys into the HuggingFace format.
...
def mapper_from_huggingface_qwen3p5_moe_for_causal_lm(
    params: Qwen3p5MoEParameters, *, head_prefix: str = SINGLE_HEAD_PREFIX
) -> ModelStateMapper:
    """Creates a state mapper translating Qwen3.5 MoE Causal LM HuggingFace keys into the d9d format.
    ...
    return ModelStateMapperParallel(
        [
            ModelStateMapperPrefixScope(
                mapper_from_huggingface_qwen3p5_moe(params),
                source_prefix="model.",
                target_prefix="model.",
            ),
...
def mapper_to_huggingface_qwen3p5_moe_for_causal_lm(
    params: Qwen3p5MoEParameters, *, head_prefix: str = SINGLE_HEAD_PREFIX
) -> ModelStateMapper:
    """Creates a state mapper translating d9d Qwen3.5 MoE Causal LM keys into the HuggingFace format.
    ...
    return ModelStateMapperParallel(
        [
            ModelStateMapperPrefixScope(
                mapper_to_huggingface_qwen3p5_moe(params),
                source_prefix="model.",
                target_prefix="model.",
            ),
...
def mapper_from_huggingface_qwen3p5_moe_for_conditional_generation(
    params: Qwen3p5MoEParameters,
    vision: Qwen3p5MoEVisionParameters,
    *,
    head_prefix: str = SINGLE_HEAD_PREFIX,
) -> ModelStateMapper:
    """Creates a state mapper translating multimodal Qwen3.5 MoE HuggingFace keys into the d9d format.
    ...
    return ModelStateMapperParallel(
        [
            ...
            ModelStateMapperPrefixScope(
                mapper_from_huggingface_qwen3p5_moe_vision(vision),
...
def mapper_to_huggingface_qwen3p5_moe_for_conditional_generation(
    params: Qwen3p5MoEParameters,
    vision: Qwen3p5MoEVisionParameters,
    *,
    head_prefix: str = SINGLE_HEAD_PREFIX,
) -> ModelStateMapper:
    """Creates a state mapper translating d9d multimodal Qwen3.5 MoE keys into the HuggingFace format.
    ...
    return ModelStateMapperParallel(
        [
            ...
            ModelStateMapperPrefixScope(
                mapper_to_huggingface_qwen3p5_moe_vision(vision),
